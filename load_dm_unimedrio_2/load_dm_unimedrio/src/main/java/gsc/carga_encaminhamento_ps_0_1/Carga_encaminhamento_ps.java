...
package gsc.carga_encaminhamento_ps_0_1;
...
/**
 * Job: Carga_encaminhamento_ps Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Carga_encaminhamento_ps implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Carga_encaminhamento_ps";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Carga_encaminhamento_ps.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Carga_encaminhamento_ps.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_GSC_Carga_encaminhamento_ps = new byte[0];
    static byte[] commonByteArray_GSC_Carga_encaminhamento_ps = new byte[0];
			    ...
			    public String ps_motivo_antigos;

				public String getPs_motivo_antigos () {
					return this.ps_motivo_antigos;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GSC_Carga_encaminhamento_ps.length) {
				if(length < 1024 && commonByteArray_GSC_Carga_encaminhamento_ps.length == 0) {
   					commonByteArray_GSC_Carga_encaminhamento_ps = new byte[1024];
				} else {
   					commonByteArray_GSC_Carga_encaminhamento_ps = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GSC_Carga_encaminhamento_ps, 0, length);
			strReturn = new String(commonByteArray_GSC_Carga_encaminhamento_ps, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GSC_Carga_encaminhamento_ps) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.ps_motivo_antigos = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.ps_motivo_antigos,dos);
    ...
    public String toString() {
		...
		sb.append(",ps_motivo_antigos="+ps_motivo_antigos);
...
String dbUser_tSQLDWHOutput_1 = null;
	...
	final String decryptedPassword_tSQLDWHOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:fldK45i/Cl1RFZm8g/mOTH9wMdZOsE0kTCD9UVfJW65vhPPDpc0P");
...
if(dbschema_tSQLDWHOutput_1 == null || dbschema_tSQLDWHOutput_1.trim().length() == 0) {
    tableName_tSQLDWHOutput_1 = "tb_encaminhamento_ps";
} else {
    tableName_tSQLDWHOutput_1 = dbschema_tSQLDWHOutput_1 + "].[" + "tb_encaminhamento_ps";
}
	int count_tSQLDWHOutput_1=0;
        ...
        String insert_tSQLDWHOutput_1 = "INSERT INTO [" + tableName_tSQLDWHOutput_1 + "] ([pac_codigo],[pac_nome],[pac_dt_nasc],[cnv_nome],[nivel_nome],[pac_end],[pac_num],[pac_bairro],[pac_cid],[pac_UF],[pac_cep],[int_dt_entrada],[ps_motivo_antigos],[cid10n4_Cod],[dt_atlz]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:/iJb3NR7Gbeq3tJ4dCfLF02A/Nq7JAUbPa/Cm7+N/Q2snnKq8io=");
...
+"b.pac_cid\n,b.`pac_UF`\n,b.pac_cep\n,a.ps_dt_entrada\n,a.ps_motivo_antigos\n,e.`cid10n4_Cod` \n,CONCAT (b.pac_sys_dt_alt"
+",' ', b.pac_sys_hr_alt,':00') as dt_atlz\nfrom gss_passagem_pronto_socorro a\ninner join gsc_paciente b on a.pac_codigo "
+"= b.pac_codigo\ninner join gsc_convenio c on c.cnv_codigo = b.cnv_codigo\ninner join gsc_nivel_atencao_360 d on d.nivel_"
+"codigo = b.pro_codigo\nleft join gss_cid10n4 e on e.`cid10n4_Cod` = a.ps_motivo \nwhere b.cnv_codigo = 114 ;";
				...
				if(rs_tDBInput_1.getString(12) != null) {
					...
					row1.int_dt_entrada =  null;
							...
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.ps_motivo_antigos = null;
							} else {
	                         		
        	row1.ps_motivo_antigos = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
        	...
        	row1.cid10n4_Cod = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
				...
				if(rs_tDBInput_1.getString(15) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.dt_atlz = rs_tDBInput_1.getTimestamp(15);
					} else {
...
pstmt_tSQLDWHOutput_1.setTimestamp(3, new java.sql.Timestamp(row2.pac_dt_nasc.getTime()));
} else {
...
} else {pstmt_tSQLDWHOutput_1.setString(4, row2.cnv_nome);
}

                    if(row2.nivel_nome == null) {
pstmt_tSQLDWHOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tSQLDWHOutput_1.setString(5, row2.nivel_nome);
}
...
pstmt_tSQLDWHOutput_1.setNull(11, java.sql.Types.VARCHAR);
                    ...
                    if(row2.int_dt_entrada != null) {
pstmt_tSQLDWHOutput_1.setTimestamp(12, new java.sql.Timestamp(row2.int_dt_entrada.getTime()));
} else {
pstmt_tSQLDWHOutput_1.setNull(12, java.sql.Types.DATE);
}

                    if(row2.ps_motivo_antigos == null) {
pstmt_tSQLDWHOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tSQLDWHOutput_1.setString(13, row2.ps_motivo_antigos);
}

                    if(row2.cid10n4_Cod == null) {
pstmt_tSQLDWHOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tSQLDWHOutput_1.setString(14, row2.cid10n4_Cod);
}

                    if(row2.dt_atlz != null) {
pstmt_tSQLDWHOutput_1.setTimestamp(15, new java.sql.Timestamp(row2.dt_atlz.getTime()));
} else {
 ...
 */
    ...
    public static void main(String[] args){
        final Carga_encaminhamento_ps Carga_encaminhamento_psClass = new Carga_encaminhamento_ps();

        int exitCode = Carga_encaminhamento_psClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Carga_encaminhamento_ps.class.getClassLoader().getResourceAsStream("gsc/carga_encaminhamento_ps_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Carga_encaminhamento_ps.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Carga_encaminhamento_ps");
        }
...
/************************************************************************************************
 *     65856 characters generated by Talend Open Studio for Data Integration 
