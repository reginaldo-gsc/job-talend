...
package gsc.carga_teleconsulta_ad_0_1;
...
/**
 * Job: Carga_teleconsulta_ad Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Carga_teleconsulta_ad implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Carga_teleconsulta_ad";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Carga_teleconsulta_ad.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Carga_teleconsulta_ad.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_GSC_Carga_teleconsulta_ad = new byte[0];
    static byte[] commonByteArray_GSC_Carga_teleconsulta_ad = new byte[0];
			    ...
			    public String pac_dt_nasc;

				public String getPac_dt_nasc () {
			    ...
			    public String pac_comp;

				public String getPac_comp () {
					return this.pac_comp;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GSC_Carga_teleconsulta_ad.length) {
				if(length < 1024 && commonByteArray_GSC_Carga_teleconsulta_ad.length == 0) {
   					commonByteArray_GSC_Carga_teleconsulta_ad = new byte[1024];
				} else {
   					commonByteArray_GSC_Carga_teleconsulta_ad = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GSC_Carga_teleconsulta_ad, 0, length);
			strReturn = new String(commonByteArray_GSC_Carga_teleconsulta_ad, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GSC_Carga_teleconsulta_ad) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.pac_dt_nasc = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.pac_dt_nasc,dos);
    ...
    public String toString() {
		...
		sb.append(",pac_dt_nasc="+pac_dt_nasc);
...
String dbUser_tSQLDWHOutput_1 = null;
	...
	final String decryptedPassword_tSQLDWHOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:m5iEtz9Y2Fd+AEToRGhQRpeTl0DzSBqd4+qhXc5o7L1Dh7hJjdcI");
...
if(dbschema_tSQLDWHOutput_1 == null || dbschema_tSQLDWHOutput_1.trim().length() == 0) {
    tableName_tSQLDWHOutput_1 = "tb_teleconsultas_ad";
} else {
    tableName_tSQLDWHOutput_1 = dbschema_tSQLDWHOutput_1 + "].[" + "tb_teleconsultas_ad";
}
	int count_tSQLDWHOutput_1=0;
        ...
        String insert_tSQLDWHOutput_1 = "INSERT INTO [" + tableName_tSQLDWHOutput_1 + "] ([pac_nome],[pac_dt_nasc],[pac_sexo],[pac_codigo],[cnv_nome],[pac_end],[pac_num],[pac_comp],[pac_bairro],[pac_UF],[pac_cep],[prod_nome],[usu_nome],[fis_nome],[data_evolucao],[evo_hr_inc]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4nsR1DwLFHjbsPpVr89+QPxW9t4fl47s7o+5beiQUEm/To/Uqhk=");
...
+"c_bairro\n,b.`pac_UF`\n,b.`pac_CEP`\n,e.prod_nome\n,f.usu_nome\n,g.fis_nome\n,a.data_evolucao\n,a.evo_hr_inc\nfrom see.s"
+"ee_evolucao_tele_medicina  a\ninner join see.see_paciente b on a.pac_codigo = b.pac_codigo\ninner join see.see_convenio "
+"c on c.cnv_codigo = b.cnv_codigo\ninner join see.see_orcamento d on d.pac_codigo = a.pac_codigo\ninner join see.see_prod"
+"uto e on e.prod_codigo = d.prod_codigo\ninner join gsc.gsc_usuario f on f.usu_login = a.usu_login\ninner join gsc.gsc_pr"
+"ofissao g on g.fis_codigo = f.prf_codigo\nwhere b.sts_codigo in (5,10,14,17,18,29,22) group by a.pac_codigo;";
        	...
        	row1.pac_dt_nasc = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
        	...
        	row1.pac_codigo = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
        	...
        	row1.pac_comp = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.pac_bairro = null;
							} else {
	                         		
        	row1.pac_bairro = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
        	...
        	row1.prod_nome = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.usu_nome = null;
							} else {
	                         		
        	row1.usu_nome = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.fis_nome = null;
							} else {
	                         		
        	row1.fis_nome = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row1.data_evolucao = null;
							} else {
				...
				if(rs_tDBInput_1.getString(15) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.data_evolucao = rs_tDBInput_1.getTimestamp(15);
					} else {
						row1.data_evolucao = (java.util.Date) year0_tDBInput_1.clone();
					}
				} else {
					row1.data_evolucao =  null;
				}
							...
							if(colQtyInRs_tDBInput_1 < 16) {
								row1.evo_hr_inc = null;
							} else {
	                         		
        	row1.evo_hr_inc = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, false);
		                    }
...
} else {pstmt_tSQLDWHOutput_1.setString(2, row2.pac_dt_nasc);
}

                    if(row2.pac_sexo == null) {
pstmt_tSQLDWHOutput_1.setNull(3, java.sql.Types.CHAR);
} else {if(row2.pac_sexo == null) {
pstmt_tSQLDWHOutput_1.setNull(3, java.sql.Types.CHAR);
} else if(row2.pac_sexo == ' '){
pstmt_tSQLDWHOutput_1.setString(3, "");
} else {
pstmt_tSQLDWHOutput_1.setString(3, String.valueOf(row2.pac_sexo));
}}

                    if(row2.pac_codigo == null) {
pstmt_tSQLDWHOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tSQLDWHOutput_1.setString(4, row2.pac_codigo);
}

                    if(row2.cnv_nome == null) {
pstmt_tSQLDWHOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tSQLDWHOutput_1.setString(5, row2.cnv_nome);
}
...
} else {pstmt_tSQLDWHOutput_1.setString(12, row2.prod_nome);
}

                    if(row2.usu_nome == null) {
pstmt_tSQLDWHOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tSQLDWHOutput_1.setString(13, row2.usu_nome);
}

                    if(row2.fis_nome == null) {
pstmt_tSQLDWHOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tSQLDWHOutput_1.setString(14, row2.fis_nome);
}

                    if(row2.data_evolucao != null) {
pstmt_tSQLDWHOutput_1.setTimestamp(15, new java.sql.Timestamp(row2.data_evolucao.getTime()));
} else {
pstmt_tSQLDWHOutput_1.setNull(15, java.sql.Types.DATE);
}

                    if(row2.evo_hr_inc == null) {
pstmt_tSQLDWHOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tSQLDWHOutput_1.setString(16, row2.evo_hr_inc);
}
 ...
 */
    ...
    public static void main(String[] args){
        final Carga_teleconsulta_ad Carga_teleconsulta_adClass = new Carga_teleconsulta_ad();

        int exitCode = Carga_teleconsulta_adClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Carga_teleconsulta_ad.class.getClassLoader().getResourceAsStream("gsc/carga_teleconsulta_ad_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Carga_teleconsulta_ad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Carga_teleconsulta_ad");
        }
...
/************************************************************************************************
 *     66088 characters generated by Talend Open Studio for Data Integration 
