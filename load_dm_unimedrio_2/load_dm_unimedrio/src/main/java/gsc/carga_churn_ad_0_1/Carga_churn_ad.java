...
package gsc.carga_churn_ad_0_1;
...
/**
 * Job: Carga_churn_ad Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Carga_churn_ad implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Carga_churn_ad";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Carga_churn_ad.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Carga_churn_ad.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_GSC_Carga_churn_ad = new byte[0];
    static byte[] commonByteArray_GSC_Carga_churn_ad = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GSC_Carga_churn_ad.length) {
				if(length < 1024 && commonByteArray_GSC_Carga_churn_ad.length == 0) {
   					commonByteArray_GSC_Carga_churn_ad = new byte[1024];
				} else {
   					commonByteArray_GSC_Carga_churn_ad = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GSC_Carga_churn_ad, 0, length);
			strReturn = new String(commonByteArray_GSC_Carga_churn_ad, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GSC_Carga_churn_ad) {
...
String dbUser_tSQLDWHOutput_1 = null;
	...
	final String decryptedPassword_tSQLDWHOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ZQpwFpkCcZv2tIJBVDTVSAMMaaZdvIo/Tex95nQHqaaLauEwqA8A");
...
if(dbschema_tSQLDWHOutput_1 == null || dbschema_tSQLDWHOutput_1.trim().length() == 0) {
    tableName_tSQLDWHOutput_1 = "tb_churn_ad";
} else {
    tableName_tSQLDWHOutput_1 = dbschema_tSQLDWHOutput_1 + "].[" + "tb_churn_ad";
}
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:X3mzCZRSIVgMIztP93t3srS8x35UH0RRyGb01hq8EQBcc7qIvYI=");
 ...
 */
    ...
    public static void main(String[] args){
        final Carga_churn_ad Carga_churn_adClass = new Carga_churn_ad();

        int exitCode = Carga_churn_adClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Carga_churn_ad.class.getClassLoader().getResourceAsStream("gsc/carga_churn_ad_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Carga_churn_ad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Carga_churn_ad");
        }
...
/************************************************************************************************
 *     61554 characters generated by Talend Open Studio for Data Integration 
