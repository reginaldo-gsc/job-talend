...
package gsc.carga_implementacao_ad_0_1;
...
/**
 * Job: Carga_implementacao_ad Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Carga_implementacao_ad implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Carga_implementacao_ad";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Carga_implementacao_ad.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Carga_implementacao_ad.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_GSC_Carga_implementacao_ad = new byte[0];
    static byte[] commonByteArray_GSC_Carga_implementacao_ad = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GSC_Carga_implementacao_ad.length) {
				if(length < 1024 && commonByteArray_GSC_Carga_implementacao_ad.length == 0) {
   					commonByteArray_GSC_Carga_implementacao_ad = new byte[1024];
				} else {
   					commonByteArray_GSC_Carga_implementacao_ad = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GSC_Carga_implementacao_ad, 0, length);
			strReturn = new String(commonByteArray_GSC_Carga_implementacao_ad, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GSC_Carga_implementacao_ad) {
...
String dbUser_tSQLDWHOutput_1 = null;
	...
	final String decryptedPassword_tSQLDWHOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:wfBDOWJkpLaLsezkDKcNTWnUd6D7VnyPABoPksH40EDlp/LVsSnb");
...
if(dbschema_tSQLDWHOutput_1 == null || dbschema_tSQLDWHOutput_1.trim().length() == 0) {
    tableName_tSQLDWHOutput_1 = "tb_implementacao_ad";
} else {
    tableName_tSQLDWHOutput_1 = dbschema_tSQLDWHOutput_1 + "].[" + "tb_implementacao_ad";
}
	int count_tSQLDWHOutput_1=0;
        ...
        String insert_tSQLDWHOutput_1 = "INSERT INTO [" + tableName_tSQLDWHOutput_1 + "] ([pac_nome],[pac_end],[pac_num],[pac_comp],[pac_bairro],[pac_UF],[pac_cep],[pac_codigo],[cnv_desc],[prod_nome],[status_orcamento],[situacao_orcamento],[valor_total],[custo_total]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Okg41BR9iLbTFXdF745duYzBaECv+1iO0tO/f+vsrlq3r9IxkrA=");
...
+"o;";
        	...
        	row1.pac_comp = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.pac_bairro = null;
							} else {
	                         		
        	row1.pac_bairro = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.pac_UF = null;
							} else {
	                         		
        	row1.pac_UF = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.pac_cep = null;
							} else {
	                         		
        	row1.pac_cep = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.pac_codigo = null;
							} else {
	                         		
        	row1.pac_codigo = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.cnv_desc = null;
							} else {
	                         		
        	row1.cnv_desc = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.prod_nome = null;
							} else {
	                         		
        	row1.prod_nome = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final Carga_implementacao_ad Carga_implementacao_adClass = new Carga_implementacao_ad();

        int exitCode = Carga_implementacao_adClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Carga_implementacao_ad.class.getClassLoader().getResourceAsStream("gsc/carga_implementacao_ad_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Carga_implementacao_ad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Carga_implementacao_ad");
        }
...
/************************************************************************************************
 *     61852 characters generated by Talend Open Studio for Data Integration 
