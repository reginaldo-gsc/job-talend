...
package gsc.carga_teleconsulta_gs_0_1;
...
/**
 * Job: Carga_teleconsulta_gs Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Carga_teleconsulta_gs implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Carga_teleconsulta_gs";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Carga_teleconsulta_gs.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Carga_teleconsulta_gs.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_GSC_Carga_teleconsulta_gs = new byte[0];
    static byte[] commonByteArray_GSC_Carga_teleconsulta_gs = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GSC_Carga_teleconsulta_gs.length) {
				if(length < 1024 && commonByteArray_GSC_Carga_teleconsulta_gs.length == 0) {
   					commonByteArray_GSC_Carga_teleconsulta_gs = new byte[1024];
				} else {
   					commonByteArray_GSC_Carga_teleconsulta_gs = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GSC_Carga_teleconsulta_gs, 0, length);
			strReturn = new String(commonByteArray_GSC_Carga_teleconsulta_gs, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GSC_Carga_teleconsulta_gs) {
...
String dbUser_tSQLDWHOutput_1 = null;
	...
	final String decryptedPassword_tSQLDWHOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:t8uSsTV2oVJSLsEzgAjKCXu1n2aaiRsxaPQixpzN5cNXpbQpJmUX");
...
if(dbschema_tSQLDWHOutput_1 == null || dbschema_tSQLDWHOutput_1.trim().length() == 0) {
    tableName_tSQLDWHOutput_1 = "tb_teleconsultas_gs";
} else {
    tableName_tSQLDWHOutput_1 = dbschema_tSQLDWHOutput_1 + "].[" + "tb_teleconsultas_gs";
}
	int count_tSQLDWHOutput_1=0;
        ...
        String insert_tSQLDWHOutput_1 = "INSERT INTO [" + tableName_tSQLDWHOutput_1 + "] ([pac_codigo],[pac_nome],[pac_dt_nasc],[pac_sexo],[cnv_nome],[pac_end],[pac_num],[pac_bairro],[pac_cid],[pac_UF],[pac_cep],[nivel_nome],[usu_nome],[fis_nome],[data_evolucao],[evo_hr_inc],[dt_atlz]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:LBJdC9iklMRMde3gcyrpwdxxy300kPvmOiCUwtb/tiv8VGEj8Ww=");
...
+"pac_cid\n,b.`pac_UF`\n,b.pac_cep\n,d.nivel_nome\n,e.usu_nome\n,f.fis_nome\n,a.data_evolucao\n,a.evo_hr_inc\n,CONCAT (b.p"
+"ac_sys_dt_alt,' ', b.pac_sys_hr_alt,':00') as dt_atlz\nfrom gsc_evolucao_tele_medicina a\ninner join gsc_paciente b on a"
+".pac_codigo = b.pac_codigo\ninner join gsc_convenio c on c.cnv_codigo = b.cnv_codigo\ninner join gsc_nivel_atencao_360 d"
+" on d.nivel_codigo = b.pro_codigo\ninner join gsc_usuario e on a.usu_login = e.usu_login\ninner join gsc_profissao f on "
+"f.fis_codigo = e.prf_codigo\nwhere b.cnv_codigo = 114;";
        	...
        	row1.pac_codigo = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
        	...
        	row1.pac_dt_nasc = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
...
} else {pstmt_tSQLDWHOutput_1.setString(1, row2.pac_codigo);
}
...
} else {pstmt_tSQLDWHOutput_1.setString(3, row2.pac_dt_nasc);
}

                    if(row2.pac_sexo == null) {
pstmt_tSQLDWHOutput_1.setNull(4, java.sql.Types.CHAR);
} else {if(row2.pac_sexo == null) {
pstmt_tSQLDWHOutput_1.setNull(4, java.sql.Types.CHAR);
} else if(row2.pac_sexo == ' '){
pstmt_tSQLDWHOutput_1.setString(4, "");
} else {
pstmt_tSQLDWHOutput_1.setString(4, String.valueOf(row2.pac_sexo));
}}
 ...
 */
    ...
    public static void main(String[] args){
        final Carga_teleconsulta_gs Carga_teleconsulta_gsClass = new Carga_teleconsulta_gs();

        int exitCode = Carga_teleconsulta_gsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Carga_teleconsulta_gs.class.getClassLoader().getResourceAsStream("gsc/carga_teleconsulta_gs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Carga_teleconsulta_gs.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Carga_teleconsulta_gs");
        }
...
/************************************************************************************************
 *     67383 characters generated by Talend Open Studio for Data Integration 
 *     on the 14 de Julho de 2020 10h54min30s BRT
 ************************************************************************************************/