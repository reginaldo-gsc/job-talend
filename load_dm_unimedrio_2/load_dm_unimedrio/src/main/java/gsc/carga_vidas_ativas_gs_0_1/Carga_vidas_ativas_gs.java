...
package gsc.carga_vidas_ativas_gs_0_1;
...
/**
 * Job: Carga_vidas_ativas_gs Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Carga_vidas_ativas_gs implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Carga_vidas_ativas_gs";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Carga_vidas_ativas_gs.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Carga_vidas_ativas_gs.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_GSC_Carga_vidas_ativas_gs = new byte[0];
    static byte[] commonByteArray_GSC_Carga_vidas_ativas_gs = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_GSC_Carga_vidas_ativas_gs.length) {
				if(length < 1024 && commonByteArray_GSC_Carga_vidas_ativas_gs.length == 0) {
   					commonByteArray_GSC_Carga_vidas_ativas_gs = new byte[1024];
				} else {
   					commonByteArray_GSC_Carga_vidas_ativas_gs = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_GSC_Carga_vidas_ativas_gs, 0, length);
			strReturn = new String(commonByteArray_GSC_Carga_vidas_ativas_gs, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_GSC_Carga_vidas_ativas_gs) {
...
String dbUser_tSQLDWHOutput_1 = null;
	...
	final String decryptedPassword_tSQLDWHOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:qxww4x6vLH3fj4GDIgibTXdBwDEVaXV6/IM6TLpYwmnLL7HpzYYz");
...
if(dbschema_tSQLDWHOutput_1 == null || dbschema_tSQLDWHOutput_1.trim().length() == 0) {
    tableName_tSQLDWHOutput_1 = "tb_vidas_ativas_gs";
} else {
    tableName_tSQLDWHOutput_1 = dbschema_tSQLDWHOutput_1 + "].[" + "tb_vidas_ativas_gs";
}
	int count_tSQLDWHOutput_1=0;
        ...
        String insert_tSQLDWHOutput_1 = "INSERT INTO [" + tableName_tSQLDWHOutput_1 + "] ([pac_nome],[pac_codigo],[cnv_nome],[pac_dt_nasc],[pac_sexo],[pac_end],[pac_num],[pac_bairro],[pac_cid],[pac_UF],[pac_cep],[nivel_nome],[dt_atlz]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:IlVlHIChowtAtx5CK4oKr2V9yjY6q+EiK0N6+bmfnM4DQ/hBn00=");
...
+"pac_cid\n,a.pac_UF\n,a.pac_cep\n,c.nivel_nome\n,CONCAT (a.pac_sys_dt_alt,' ', a.pac_sys_hr_alt,':00') as dt_atlz\nfrom g"
+"sc_paciente a\ninner join gsc_convenio b on b.cnv_codigo = a.cnv_codigo\ninner join gsc_nivel_atencao_360 c on c.nivel_c"
+"odigo = a.pro_codigo\nwhere a.sts_codigo = 7 and a.cnv_codigo = 114;";
            ...
            row1.pac_codigo = rs_tDBInput_1.getInt(2);
        	...
        	row1.nivel_nome = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
				...
				if(rs_tDBInput_1.getString(13) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.dt_atlz = rs_tDBInput_1.getTimestamp(13);
					} else {
...
pstmt_tSQLDWHOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tSQLDWHOutput_1.setInt(2, row2.pac_codigo);
}
...
pstmt_tSQLDWHOutput_1.setTimestamp(13, new java.sql.Timestamp(row2.dt_atlz.getTime()));
} else {
 ...
 */
    ...
    public static void main(String[] args){
        final Carga_vidas_ativas_gs Carga_vidas_ativas_gsClass = new Carga_vidas_ativas_gs();

        int exitCode = Carga_vidas_ativas_gsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Carga_vidas_ativas_gs.class.getClassLoader().getResourceAsStream("gsc/carga_vidas_ativas_gs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Carga_vidas_ativas_gs.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Carga_vidas_ativas_gs");
        }
...
/************************************************************************************************
 *     63446 characters generated by Talend Open Studio for Data Integration 
